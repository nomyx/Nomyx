...
inputRadio :: (Eq c, Show c, Typeable c) => ClientNumber -> String -> [(c, String)] -> Event c
inputRadio pn title cs = inputEvent $ Radio title cs

inputRadio' :: (Eq c, Show c, Typeable c) => ClientNumber -> String -> [c] -> Event c
...
inputText :: ClientNumber -> String -> Event String
...
inputCheckbox :: (Eq c, Show c, Typeable c) => ClientNumber -> String -> [(c, String)] -> Event [c]
...
inputButton :: ClientNumber -> String -> Event ()
...
inputTextarea :: ClientNumber -> String -> Event String
